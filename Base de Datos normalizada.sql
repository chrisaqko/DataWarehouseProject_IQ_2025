...
-- Dimensiones para Ubicaci�n (Provincia, Cant�n, Distrito)
...
-- Dimensiones para Condici�n Socioecon�mica, Sexo, Edad, y Educaci�n
...
-- Hechos: Situaci�n Socioecon�mica por Edad
...
-- Hechos: Situaci�n Socioecon�mica por Sexo
...
CREATE TABLE hecho_empleo_sexo (
    ...
    fecha_consulta DATE,
    fecha_actualizacion DATE,
    FOREIGN KEY (id_condicion_actividad) REFERENCES dimension_condicion_pobreza(id_condicion), -- Se ajusta seg�n tu fuente de datos
    FOREIGN KEY (id_sexo) REFERENCES dimension_sexo(id_sexo),
    FOREIGN KEY (id_provincia) REFERENCES dimension_provincia(id_provincia),
    FOREIGN KEY (id_canton) REFERENCES dimension_canton(id_canton),
    FOREIGN KEY (id_distrito) REFERENCES dimension_distrito(id_distrito)
...
CREATE TABLE hecho_beneficios_sexo (
    ...
    fecha_consulta DATE,
    fecha_actualizacion DATE,
    FOREIGN KEY (id_beneficio) REFERENCES dimension_condicion_pobreza(id_condicion), -- Se ajusta seg�n tu fuente de datos
    FOREIGN KEY (id_sexo) REFERENCES dimension_sexo(id_sexo),
    FOREIGN KEY (id_provincia) REFERENCES dimension_provincia(id_provincia),
    FOREIGN KEY (id_canton) REFERENCES dimension_canton(id_canton),
    FOREIGN KEY (id_distrito) REFERENCES dimension_distrito(id_distrito)
...
-- Hechos: Estad�sticas Policiales
